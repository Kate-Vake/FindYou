    ...
    <div class="container bg-grey" id="contact">
        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <p><span class="glyphicon glyphicon-map-marker"></span> Tirana, Albania</p>
                <p><span class="glyphicon glyphicon-phone"></span> +355 69 6060980</p>
...
<script>
    var myCenter = new google.maps.LatLng(10.2680519,45.7891479);
